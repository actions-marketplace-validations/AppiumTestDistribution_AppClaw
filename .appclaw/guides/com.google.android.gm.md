...
- **Delete**: Long press to delete email
- **Select Multiple**: Long press on the first email from the list
- **Star/Unstar**: Tap the star icon next to an email
- **Mark as Read/Unread**: Long press → Select → Tap the mark read/unread icon which looks like envelope 
